...
const createFilterSettingsForAPIFactory = (nabozenske_vyznani, narodnosti, parlamenty, vysoka_skola) => {
...
export default {
  ...
  createFilterSettingsForAPIFactory,
};
