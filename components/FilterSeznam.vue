  ...
  .filter-seznam
    ...
    .filter-seznam-bar(v-if="MaFiltr")
      ...
      .filter-seznam.bar-right
        ...
        CustomSelect(:Namespace="Komponenta"  :ZakladniPolozka="RaditZakladniPolozka" :RaditDle="RaditDle")
    ...
    .seznam-content-container()
      ...
      .seznam-filter-sidebar(v-if="MaFiltr && isSidebarOpen")
        .seznam-filter-sidebar-content
          ...
          .seznam-filter-sidebar-content-header
            p.typography-filter-heading Zobrazuje se XYZ z {{pocetPolozek}} poslanců
            ...
            .seznam-filter-sidebar-content-section-content.typography-filter-text
              ...
              ol.filter-list.filter-list-inline.filter-list-radios
                li.filter-list-item
                  label(for="pohlavi01")
                    .filter-list-item-checkbox
                      input(type="radio" id="pohlavi01" name="pohlavi" value="")
                    .filter-list-item-value Vše

                li.filter-list-item
                  label(for="pohlavi02")
                    .filter-list-item-checkbox
                      input(type="radio" id="pohlavi02" name="pohlavi" value="")
                    .filter-list-item-value Muž

                li.filter-list-item
                  label(for="pohlavi03")
                    .filter-list-item-checkbox
                      input(type="radio" id="pohlavi03" name="pohlavi" value="")
      ...
      .seznam-filter-list
        ...
        .columns.is-multiline.is-mobile(v-if="Komponenta == 'Poslanec'")

          Poslanec(
            v-for="poslanec in Polozky"
...
export default {
  ...
  computed: {
    ...
    pocetPolozek: function() {
      return this.Polozky.length;
    },
  },
  methods: {
  ...
  props: ['PoslanciStatistiky', 'Polozky', 'MaFiltr', 'RaditZakladniPolozka', 'RaditDle', 'Komponenta', 'MaButtonMore', 'MaPaginaci', 'ButtonMoreLink', 'MaStatistiky'],
}
</script>
